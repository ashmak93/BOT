...
class AIService:
    ...
    def generate_response(self, text: str) -> str:
        ...
        prompt = f"""Сгенерируй вежливый, уместный и короткий ответ на это сообщение от лица того, кому прислали сообщение. Если это не сообщение, всегда отвечай "Не могу сгенерировать ответ." 
